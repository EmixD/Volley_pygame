...
class player:
    def __init__(self):
        ...
        trfoot=ftrap.trap(-10,-10, 10,-10, 10,10, -10,10,   200,390,0,[20,20,20])
        trfoot.add_floor_collision(2)
        trfoot.add_floor_collision(3)
        trleglow=ftrap.trap(-10,-25, 10,-25, 10,25, -10,25,  200,355,0,[20,20,100])
        trleghig=ftrap.trap(-10,-25, 10,-25, 10,25, -10,25,   200,305,0,[20,20,50])
        trbody=ftrap.trap(-15,-40, 15,-40, 15,40, -15,40,   200,240,0,[20,20,100])
        trarmlow=ftrap.trap(-10,-20, 10,-20, 10,20, -10,20,     200,180,0,[20,20,150])
        trarmhig=ftrap.trap(-5,-20, 5,-20, 10,20, -10,20,    200,140,0,[50,20,150])
        trhand=ftrap.trap(-5,-10, 0,-10, 5,10, -5,10,    200,110,0,[20,20,200])
        ...
        jleggigbody=fjoi.joints(trleghig,0,1,trbody,3,2)
    ...
    def calc_forces(self):
        for t in self.traps:
            t.force_cm=np.array([0,fwc.g*t.m]) #init+gravity
            t.force_mom=0 #init
